        ...
        for sea in seasons:
            ...
            for prop in sfc_props: 
                ...
                if prop == 'log_hc':
                    ...
                    xvals = pert['hc']  #use regular roughness for x
                    if np.isnan(xvals[4]):
                        xvals = xvals[0:3]
                    ...
                    lin_fit_y = intercept[sea]['log_hc'][idx_y,idx_x] + np.log(x)*slope[sea]['log_hc'][idx_y,idx_x]
                    
                    lbl = ('Log-linear fit: ' + '%.2f' % slope[sea]['log_hc'][idx_y,idx_x] + ' K/ '
                           + 'log_hc' + '(' + units +') \n r^2 = ' + np.str(r_value[sea]['log_hc'][idx_y,idx_x]) )
...
#%%
## variable y-axis - picks its own
#            
##%Loop over locations
#do_line_plots_vary=1
#if do_line_plots_vary==1:
#    
#    for nm in location_names:
#        location = nm
#        idx_x = locations[nm]['loc_x']
...
#                
#                if prop == 'log_hc':
#                    #special log-plot instance
#                    plot_log = 0    # 1 for log-shaped plot, 0 for semilogx plot (log axis)
#                    if plot_log==1:
#                        xvals = pert['hc']  #use regular roughness for x
#                        if np.isnan(xvals[4]):
#                            xvals = xvals[0:3]
...
#                ylim = ax.get_ylim()
#                yrange = ylim[1]-ylim[0]
#                    # buffer by 5% above and below, don't let it get smaller than 0.5 K 
#                ylim_alb[0]=ylim[0]-0.05*yrange
#                if yrange<0.5:
#                     ylim_alb[1] = ylim[0]+0.5
#                else:
#                     ylim_alb[1] = ylim[1]+0.05*yrange
#                    #ylim_alb[1] = ylim[1] + 0.05*yrange
#                    #ylim_alb[1] = ylim[1]+1
...
#            ax0 = axes.flatten()[0]
#            plt.sca(ax0)
#            ax0.text(0.,-0.4,time.strftime("%x")+'\n' + sea + ', '+location , fontsize='10',
#                         ha = 'left',va = 'center',
#                         transform = ax0.transAxes)
#            
#            # Full-figure save:
#            filename = location + '_response_curves_' + sea + '_loglin_vary'
#            fig_png = figpath+'/sensitivity/point_maps/'+filename+'.png'
#            print(fig_png)
#            fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
#                            edgecolor='w',orientation='portrait',bbox_inches='tight', 
...
#                ax1 = axes.flatten()[j]
#                plt.sca(ax1)
#                ax1.text(0.,-0.4,time.strftime("%x")+'\n'+sea +', ' + location + ', ' + sfc_props[j] +'_loglin' ,fontsize='10',
#                             ha = 'left',va = 'center',
#                             transform = ax1.transAxes)
#                extent = ax1.get_window_extent().transformed(fig.dpi_scale_trans.inverted())
#                filename = location+'_response_curve_' + sea + '_' + sfc_props[j]+'_loglin_vary'
#                fig_png = figpath+'/sensitivity/point_maps/'+filename+'.png'
#                vals = extent.extents
#                new_extent = extent.from_extents(vals[0]-0.5,vals[1]-1.5,vals[2]+0.25,vals[3]+0.45)
#                fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
...
#    
#
##%% Variable y axis with log-shaped log_hc plot
#            
##%% Loop over locations
#do_line_plots_vary=1
#if do_line_plots_vary==1:
...
#                if prop == 'log_hc':
#                    #special log-plot instance
#                    plot_log = 1    # 1 for log-shaped plot, 0 for semilogx plot (log axis)
#                    if plot_log==1:
#                        xvals = pert['hc']  #use regular roughness for x
#                        if np.isnan(xvals[4]):
#                            xvals = xvals[0:3]
...
#                    ylim_alb[0]=ylim[0]-0.05*yrange
#                    
#                    # if yrange < 0.5 K, call "insensitive" and force at least 0.5 K range
#                    if yrange < 0.5:
#                        ylim_alb[1] = ylim[0]+0.5
#                    else:
#                        ylim_alb[1] = ylim[1] + 0.05*yrange
...
#            
#            # Full-figure save:
#            filename = location + '_response_curves_' + sea + '_logshaped'+'_varax'
#            fig_png = figpath+'/sensitivity/point_maps/'+filename+'.png'
#            print(fig_png)
#            fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
#                            edgecolor='w',orientation='portrait',bbox_inches='tight', 
...
#                ax1 = axes.flatten()[j]
#                plt.sca(ax1)
#                ax1.text(0.,-0.4,time.strftime("%x")+'\n'+sea +', ' + location + ', ' + sfc_props[j] +'_logshaped',fontsize='10',
#                             ha = 'left',va = 'center',
#                             transform = ax1.transAxes)
#                extent = ax1.get_window_extent().transformed(fig.dpi_scale_trans.inverted())
#                filename = location+'_response_curve_' + sea + '_' + sfc_props[j] + '_logshape_varax'
#                fig_png = figpath+'/sensitivity/point_maps/'+filename+'.png'
#                vals = extent.extents
#                new_extent = extent.from_extents(vals[0]-0.5,vals[1]-1.5,vals[2]+0.25,vals[3]+0.45)
#                fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
...
#            
#            # Full-figure save:
#            filename = location + '_response_curves_' + sea + '_fixedy'
#            fig_png = figpath+'/sensitivity/point_maps/fixed_lim/'+filename+'.png'
#            print(fig_png)
#            fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
#                            edgecolor='w',orientation='portrait',bbox_inches='tight', 
#                            pad_inches=0.1,frameon=None)
...
#                ax1 = axes.flatten()[j]
#                plt.sca(ax1)
#                ax1.text(0.,-0.4,time.strftime("%x")+'\n'+sea +', ' + location + ', ' + sfc_props[j] ,fontsize='10',
#                             ha = 'left',va = 'center',
#                             transform = ax1.transAxes)
#                extent = ax1.get_window_extent().transformed(fig.dpi_scale_trans.inverted())
#                filename = location+'_response_curve_' + sea + '_' + sfc_props[j] + '_fixedy'
#                fig_png = figpath+'/sensitivity/point_maps/fixed_lim/'+filename+'.png'
#                vals = extent.extents
#                new_extent = extent.from_extents(vals[0]-0.5,vals[1]-1.5,vals[2]+0.25,vals[3]+0.45)
#                fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
...
#            
#if do_line_plots_fixed_range==1:
#    
#    for nm in location_names:
#        location = nm
#        idx_x = locations[nm]['loc_x']
...
#                    #yrange = ylim[1]-ylim[0]
#                    # buffer by 5% above and below
#                    ylim_alb[0]=ylim[0]-0.05*(ylim[1]-ylim[0])
#                    ylim_alb[1] = ylim[1] + yrange
#                    #ylim_alb[1] = ylim[1]+1
#                    ax.set_ylim(bottom=ylim[0],top=ylim[1])
#                else:
#                    #ax.set_ylim(bottom=ylim[0],top=ylim[1])
...
#            
#            # Full-figure save:
#            filename = location + '_response_curves_' + sea + '_fxdrng'
#            fig_png = figpath+'/sensitivity/point_maps/fixed_lim/'+filename+'.png'
#            print(fig_png)
#            fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
#                            edgecolor='w',orientation='portrait',bbox_inches='tight', 
...
#                             transform = ax1.transAxes)
#                extent = ax1.get_window_extent().transformed(fig.dpi_scale_trans.inverted())
#                filename = location+'_response_curve_' + sea + '_' + sfc_props[j] + '_fxdrng'
#                fig_png = figpath+'/sensitivity/point_maps/fixed_lim/'+filename+'.png'
#                vals = extent.extents
#                new_extent = extent.from_extents(vals[0]-0.5,vals[1]-1.5,vals[2]+0.25,vals[3]+0.45)
#                fig.savefig(fig_png,dpi=600,transparent=True,facecolor='w',
